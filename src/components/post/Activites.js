...
function Activites({imgDocId,userId ,liked,setLiked,commentIcomClick}){
    ...
    return (
            <div className="activites"> {
                liked?
                <svg onClick={likeHandler}  aria-label="Unlike" className="_ab6-" color="#ed4956" fill="#ed4956" height="24" 
                ...
                :
                <svg onClick={likeHandler} style={{cursor:'pointer'}} aria-label="Like" className="_ab6-" color="#262626" fill="#262626" height="24" 
                role="img" viewBox="0 0 24 24" width="24">
                    ...
                    6.052 6.052 0 00-4.787-2.127A6.985 6.985 0 00.5 9.122c0 3.61 2.55 5.827 5.015 
                    7.97.283.246.569.494.853.747l1.027.918a44.998 44.998 0 003.518 3.018 2 2 0 002.174 0 
                    45.263 45.263 0 003.626-3.115l.922-.824c.293-.26.59-.519.885-.774 2.334-2.025 4.98-4.32 
                    4.98-7.94a6.985 6.985 0 00-6.708-7.218z"></path></svg>
                    
                }
                {/* <FontAwesomeIcon className="comment" icon={faComment}/> */}
                <svg onClick={commentIcomClick} style={{cursor:'pointer'}} aria-label="Comment" className="_ab6-" color="#262626" fill="#262626" height="24" 
                role="img" viewBox="0 0 24 24" width="24">
...
export default React.memo(Activites);
